...
- Calculation of free and total Ca²⁺, Mg²⁺, K⁺, Na⁺, and Cl⁻
- Support for EGTA, BAPTA, HDTA, PCr, PEP, and HPO₄
- Adjustable pCa, pH, temperature, free Mg, and ionic strength
- Browser-based interface with no installation required

## Usage

Open the live GitHub Pages site, enter your solution conditions, and click **Calculate Solution**.

## Notes

This tool is intended for research use.
